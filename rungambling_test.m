...
[sp.AgapList, idx] = Shuffle([1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3]); % Agap on average is 12 seconds
sp.BList = sp.AList; % time for B offer is always 2 secs
%sp.BgapList = [1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3]; % Bgap on average 3 seconds
sp.BgapList = [1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3 1.3]; % Bgap on average 3 seconds
